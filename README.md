...
5. Run the game. The mod should be installed and it should work.
 ...
 |------------------|-----------------|:---------------------------------------------------------------------------------------------------------------------------:|:-------------------------------------------------------------------------------------------------------------:|
 | v2025.10.24      | Ver. 1.2.3      |   **[Download](https://github.com/PierreMauger/BetterPolus/releases/download/v1.2.3/BetterPolus-v1.2.3.zip)**    |       **[Download](https://github.com/PierreMauger/BetterPolus/releases/download/v1.2.3/BetterPolus.dll)**        |
